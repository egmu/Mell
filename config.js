...
global.nomorown2 = '6289519240209'
global.nomorwa = '0'
global.limitawal = {
...
global.author = 'Matchaalalumu' //ganti aja cuyyy
...
global.wm2 = 'Matchaalalumu' //ganti ajaa 
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`//ga usah dehhh 
global.bottime = `T I M E : ${wktuwib}` //ini juga ga usah 
global.titlebot = `Amelia-Md | Matchaalalumu` //gantu aja
global.stickpack = 'Amelia-Modz' //ganti 
global.stickauth = `© Amelia-Md` //gantii 
global.week = `${week} ${date}`
global.wibb = `${wktuwib}`
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ OWNER INFO ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.nameown1= 'Matchaalalumu' //ganti 
global.nameown2 = 'Matchaalalumu' //ganti 
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ MEDIA LINK ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
...
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ MEDIA SOSSIAL ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.sig = 'https://instagram.com/yusufriz00' //ganti jadi ig mu
...
global.snh = 'https://youtube.com/@DEVIL-X-CODE' //yt klo punya 
